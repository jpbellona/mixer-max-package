...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 471.5, 337.5, 77.0, 40.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 324.816711, 310.5, 138.0, 24.0 ],
					"text" : "VOLUME RESET"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 482.450012, 510.0, 77.0, 51.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 365.316711, 549.0, 32.5, 18.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 365.316711, 580.0, 117.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 365.316711, 510.0, 91.933289, 20.0 ],
					"text" : "gate 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 562.75, 395.0, 48.0, 20.0 ],
					"text" : "route 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 562.75, 337.5, 72.0, 18.0 ],
					"text" : "loadmess poll"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 562.75, 364.0, 73.0, 20.0 ],
					"text" : "mousestate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 411.25, 429.0, 25.5, 18.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 438.25, 429.0, 25.5, 18.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 438.25, 400.0, 84.0, 20.0 ],
					"text" : "select volume"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 438.25, 463.0, 143.5, 20.0 ],
					"text" : "gate 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 324.816711, 382.5, 69.0, 29.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "int", "int", "int", "int", "int" ],
					"patching_rect" : [ 324.816711, 423.0, 73.0, 20.0 ],
					"text" : "modifiers"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 411.25, 380.0, 84.0, 20.0 ],
					"text" : "select volume"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 411.25, 345.0, 59.5, 20.0 ],
					"text" : "hover"
				}
