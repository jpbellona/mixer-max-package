...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "@vol", -3, "@module", 0, "@loop", 1, "@file", 3 ],
					"id" : "obj-3",
					"maxclass" : "bpatcher",
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 245.0, 163.0, 225.0, 96.5 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 147.0, 333.0, 74.0, 21.0 ],
					"text" : "pan is 0-127",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 155.0, 487.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 97.0, 333.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 97.0, 362.0, 43.0, 18.0 ],
					"text" : "pan $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 469.0, 535.0, 150.0, 36.0 ],
					"text" : "mixer.pan.stereo may also be used as an abstraction",
					"textcolor" : [ 0.426676, 0.426663, 0.42667, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 155.0, 442.5, 205.0, 36.0 ],
					"text" : "you can also use pattr to directly control the object",
					"textcolor" : [ 0.426676, 0.426663, 0.42667, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 155.0, 518.5, 145.0, 20.0 ],
					"text" : "pattrforward mixer.pan::pan"
				}

			}
, 			{
				"box" : 				{
					"args" : [ "@vol", -9, "@module", 0, "@loop", 1 ],
					"id" : "obj-10",
					"maxclass" : "bpatcher",
					"name" : "demosound.maxpat",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 527.0, 509.0, 91.0, 20.0 ],
					"text" : "mixer.pan.stereo",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 11.0, 391.0, 105.0, 57.0 ],
					"varname" : "mixer.pan"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-33",
					"ignoreclick" : 1,
					"jsarguments" : [ "mixer.pan.stereo", 85 ],
					"maxclass" : "jsui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 254.5, 288.75, 63.5, 288.75 ],
					"source" : [ "obj-3", 0 ]
				}
