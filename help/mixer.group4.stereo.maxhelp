...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 595.0, 246.25, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 607.0, 293.25, 76.0, 21.0 ],
					"text" : "ch. 2 volume",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 595.0, 275.25, 71.0, 18.0 ],
					"text" : "2 volume $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 466.5, 388.5, 139.0, 18.0 ],
					"text" : "pattrstorage mixergroupst"
				}

			}
, 			{
				"box" : 				{
					"autorestore" : "mixergroupst.json",
					"fontname" : "Gill Sans",
					"fontsize" : 12.0,
					"id" : "obj-31",
					"maxclass" : "newobj",
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 466.5, 451.5, 139.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 539.0, 293.25, 65.0, 21.0 ],
					"text" : "ch. 4 mute",
					"textcolor" : [ 0.426676, 0.426663, 0.42667, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 529.0, 246.25, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 529.0, 275.25, 61.0, 18.0 ],
					"text" : "4 mute $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 477.0, 293.25, 57.0, 21.0 ],
					"text" : "ch. 3 pan",
					"textcolor" : [ 0.426676, 0.426663, 0.42667, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 468.0, 195.25, 171.0, 51.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 468.0, 246.25, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 468.0, 275.25, 53.0, 18.0 ],
					"text" : "3 pan $1"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-1",
					"maxclass" : "bpatcher",
					"name" : "mixer.group4.stereo.maxpat",
					"numinlets" : 9,
					"numoutlets" : 6,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal" ],
...
, 			{
				"box" : 				{
					...
					"id" : "obj-33",
					"ignoreclick" : 1,
					"jsarguments" : [ "mixer.group4.stereo", 85 ],
					"maxclass" : "jsui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 79.900002, 565.25, 46.5, 565.25 ],
					"source" : [ "obj-1", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 477.5, 306.625, 317.5, 306.625 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 604.5, 318.625, 317.5, 318.625 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 538.5, 313.625, 317.5, 313.625 ],
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-1::obj-52::obj-17::obj-26" : [ "aux4_level[1]", "live.gain~", 0 ],
			"obj-1::obj-35::obj-17::obj-27" : [ "aux1_level[2]", "live.gain~", 0 ],
			...
			"obj-1::obj-55::obj-17::obj-24" : [ "aux2_level", "live.gain~", 0 ],
			...
			"obj-1::obj-52::obj-17::obj-27" : [ "aux1_level[1]", "live.gain~", 0 ],
			"obj-2::obj-52::obj-17::obj-25" : [ "aux3_level[5]", "live.gain~", 0 ],
			"obj-1::obj-33::obj-17::obj-25" : [ "aux3_level[3]", "live.gain~", 0 ],
			"obj-1::obj-55::obj-17::obj-27" : [ "aux1_level", "live.gain~", 0 ],
			"obj-1::obj-55::obj-17::obj-25" : [ "aux3_level", "live.gain~", 0 ],
			...
			"obj-1::obj-33::obj-17::obj-24" : [ "aux2_level[3]", "live.gain~", 0 ],
			...
			"obj-1::obj-55::obj-17::obj-26" : [ "aux4_level", "live.gain~", 0 ],
			"obj-2::obj-33::obj-17::obj-24" : [ "aux2_level[7]", "live.gain~", 0 ],
			"obj-2::obj-33::obj-4" : [ "live.gain~[9]", "live.gain~", 0 ],
			"obj-1::obj-35::obj-17::obj-25" : [ "aux3_level[2]", "live.gain~", 0 ],
			"obj-2::obj-35::obj-17::obj-26" : [ "aux4_level[6]", "live.gain~", 0 ],
			"obj-1::obj-35::obj-17::obj-24" : [ "aux2_level[2]", "live.gain~", 0 ],
			"obj-1::obj-33::obj-17::obj-26" : [ "aux4_level[3]", "live.gain~", 0 ],
			...
			"obj-1::obj-35::obj-17::obj-26" : [ "aux4_level[2]", "live.gain~", 0 ],
			"obj-1::obj-52::obj-17::obj-25" : [ "aux3_level[1]", "live.gain~", 0 ],
			"obj-2::obj-35::obj-17::obj-27" : [ "aux1_level[6]", "live.gain~", 0 ],
			"obj-1::obj-52::obj-17::obj-24" : [ "aux2_level[1]", "live.gain~", 0 ],
			"obj-1::obj-33::obj-17::obj-27" : [ "aux1_level[3]", "live.gain~", 0 ],
